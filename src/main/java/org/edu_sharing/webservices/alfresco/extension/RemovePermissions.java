 ...
 *         &lt;element name="_permissions" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "removePermissions")
public class RemovePermissions {
    ...
    @XmlElement(name = "_permissions", required = true)
